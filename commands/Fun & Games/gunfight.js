module.exports = {
  category: "Fun & Games",
  description: "Replies with a fun interactive gun fight game within Discord.",

  callback: async ({ message, interaction }) => {
    const opponent = message.mentions.users.first();
    if(!opponent) {
        message.reply('You need to ping someone to play with... I get it, I dont have friends either.')
        return;
    }
    const positions = {
      three:
